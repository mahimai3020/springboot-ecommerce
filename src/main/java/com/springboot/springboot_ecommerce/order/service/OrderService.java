...
private UserRepository userRepo;
    ...
    @Autowired
    private ProductRepository productRepo; // ✅ FIXED

    // ================= SEARCH =================
    public List<Order> search(Long userId, Long sellerId, Long productId, String status) {
        return orderRepo.search(userId, sellerId, productId, status);
    }
...
public ApiResponse<Order> retryPayment(Long orderId,
    ...
    return pay(orderId, request, user);   // reuse logic
}
...
public ApiResponse<Order> updateDeliveryStatus(Long orderId,
    ...
    // ensure this order assigned to him
